...
\title{Peapods:OS-Independent Memory Confidentiality for Cryptographic Engines}
\author{Li Congwu}
\affiliation{%
...
\thanks{This work is supported by Data Assumance and Communications Security}
