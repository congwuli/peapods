...
{\color{blue}In order to achieve security goals,we divide the operation process of Peapods into three phases:Programming phase, Compilation phase and Program execution phase.}
...
{\color{blue}Program execution phase:We can divide the program execution phase into initialization phase and protected computing phase.}
...
{\color{blue}Initialization phase:
